...
class Webdevhelper {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Webdevhelper_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Webdevhelper_Loader. Orchestrates the hooks of the plugin.
	 * - Webdevhelper_i18n. Defines internationalization functionality.
	 * - Webdevhelper_Admin. Defines all hooks for the admin area.
	 * - Webdevhelper_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Webdevhelper_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Webdevhelper_Loader    Orchestrates the hooks of the plugin.
	 */
