 ...
 * Version:           1.0.0
 * Author:            Your Personal Developer
 * Author URI:        #
 * License:           GPL-2.0+
...
function activate_webdevhelper() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/Webdevhelper_Activator.php';
	Webdevhelper_Activator::activate();
}

function deactivate_webdevhelper() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/Webdevhelper_Deactivator.php';
...
require plugin_dir_path( __FILE__ ) . 'includes/Webdevhelper.php';
